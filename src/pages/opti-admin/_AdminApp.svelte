<script lang="ts">
    ...
    import TrackingSeeder from './components/_TrackingSeeder.svelte';
    ...
    function navigateTo(view: string) {
        ...
        window.dispatchEvent(
            new CustomEvent('admin-navigate', { detail: { view } })
        );
    ...
    function updatePageTitle(view: string) {
        const titles: Record<string, string> = {
            ...
            'tracking-seeder': 'Tracking Seeder',
        };
...
<div class="admin-layout">
    ...
    <div class="admin-content">
        <div class="admin-app">
            ...
            {:else if currentView === 'tracking-seeder'}
                <div>
                    <div class="mb-6">
                        <button
                            onclick={() => navigateTo('dashboard')}
