...
export function getLoginButtonStyles(displaySettings: DisplaySettingsFragment[]): {
    btnStyles: string[];
    loginButtonSlot: string;
} {
    ...
    const allLoginServiceClasses : { [key: string]: any } = 
        {Email: 'bg-base-100 text-base-content border-base-300',
         ...
         Amazon: 'bg-[#FF9900] text-black border-[#e17d00]',
         Microsoft: 'bg-[#2F2F2F] text-white border-black',
         Slack: 'bg-[#622069] text-white border-[#591660]',
         LinkedIn: 'bg-[#0967C2] text-white border-[#0059b3]',
        };
    if(loginService) {
        btnStyles.push(`${allLoginServiceClasses[loginService]}`);
    }
    
    const allLoginServiceSlots : { [key: string]: any } = 
        {Email: `<svg aria-label="Email icon" width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g stroke-linejoin="round" stroke-linecap="round" stroke-width="2" fill="none" stroke="black"><rect width="20" height="16" x="2" y="4" rx="2"></rect><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"></path></g></svg>
  Login with Email`,
  ...
  Login with Google`,
         Facebook: `<svg aria-label="Facebook logo" width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><path fill="white" d="M8 12h5V8c0-6 4-7 11-6v5c-4 0-5 0-5 3v2h5l-1 6h-4v12h-6V18H8z"></path></svg>
  Login with Facebook`,
         xtwitter: `<svg aria-label="X logo" width="16" height="12" viewBox="0 0 300 271" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="m236 0h46l-101 115 118 156h-92.6l-72.5-94.8-83 94.8h-46l107-123-113-148h94.9l65.5 86.6zm-16.1 244h25.5l-165-218h-27.4z"/></svg>
  Login with X`,
  ...
  Login with Amazon`,
         Microsoft: `<svg aria-label="Microsoft logo" width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M96 96H247V247H96" fill="#f24f23"></path><path d="M265 96V247H416V96" fill="#7eba03"></path><path d="M96 265H247V416H96" fill="#3ca4ef"></path><path d="M265 265H416V416H265" fill="#f9ba00"></path></svg>
  ...
  Login with LinkedIn`,
    ...
    if(loginService) {
        loginButtonSlot = allLoginServiceSlots[loginService];
    }
    
    return {btnStyles, loginButtonSlot};
}
